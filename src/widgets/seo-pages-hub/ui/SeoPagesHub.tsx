    ...
    <Section id="seo-pages" variant="alt">
      <Container>
        <SectionHead
          ...
          title="Azbaan global attestation pages by city and service type"
          copy="Browse dedicated SEO pages for attestation services in Dubai, Delhi, Kochi, and specialist MOFA, degree, and commercial document support."
        />
